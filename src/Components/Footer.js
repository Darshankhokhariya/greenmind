    ...
    return (
        <>
            ...
            <footer class="w-full text-gray-700 bg-[#C1DCDC] body-font font-popins">
                <div
                    class="container flex flex-col flex-wrap px-5 py-4 md:py-12 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
                    ...
                    <div class="flex flex-wrap md:flex-nowrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                            ...
                            <nav class="mb-10 list-none">
                                <li class="mt-3">
                                    <Link to='/' class="text-color2 font-medium cursor-pointer hover:text-gray-900">Home</Link>
                                </li>
                                <li class="mt-3">
